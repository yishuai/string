...
// 1	JavaScript: Check 检查 whether 是否 an 'input' 输入 is an array or not.
...
// 2	JavaScript: Clone 克隆 an array
...
// 4	JavaScript: Get the last element 元素 of an array
...
// 5.1	JavaScript: Join 合在一起 all 所有的 elements 元素 of an array into a string
...
// 6	JavaScript: Insert 插入 dashes (-) between 之间 each two 2个 even 偶数 digits 数字 of a specific number
...
// 8	JavaScript: Find 找到 the most 最 frequent 频繁的 item 项目 of an array
...
// 11	JavaScript: Find 找到 the sum 和 of squares 平方 of a numeric 数字的 vector 向量
...
// 12	JavaScript: Compute the sum 和 and product 乘积 of an array of integers 整数
...
// 14	JavaScript: Remove 移走 duplicate 重复的 items 条目 from an array, ignore 忽略 case 大小写 sensitivity 敏感
// move 移动
...
// 18	JavaScript: Perform 执行 a binary 二进制 search 搜索 within an array
// performance： 性能，表演
// Write a JavaScript program to perform a binary search 折半.
...
// 23	JavaScript: Find the difference 不同 of two arrays
